module.exports = [
  ...
  '@select-multiple-item-height-lg',
  ...
  '@menu-icon-size',
  '@menu-icon-size-lg',
  '@menu-item-group-title-font-size',
  '@menu-dark-color',
  ...
  '@menu-dark-item-active-danger-bg',
  ...
  '@table-padding-vertical-md',
  '@table-padding-horizontal-md',
  '@table-padding-vertical-sm',
  ...
  '@card-head-font-size',
  '@card-head-font-size-sm',
  '@card-head-padding',
  '@card-head-padding-sm',
  '@card-head-height',
  '@card-head-height-sm',
  ...
  '@card-actions-li-margin',
  '@card-skeleton-bg',
  '@card-background',
  '@card-shadow',
  '@card-radius',
  '@card-head-tabs-margin-bottom',
  ...
  '@comment-actions-margin-bottom',
  '@comment-actions-margin-top',
  '@comment-content-detail-p-margin-bottom',
  '@tabs-card-head-background',
  '@tabs-card-height',
  '@tabs-card-active-color',
  '@tabs-card-horizontal-padding',
  '@tabs-card-horizontal-padding-sm',
  '@tabs-card-horizontal-padding-lg',
  ...
  '@switch-shadow-color',
  '@switch-padding',
  '@switch-inner-margin-min',
  '@switch-inner-margin-max',
  '@switch-sm-inner-margin-min',
  '@switch-sm-inner-margin-max',
  '@pagination-item-bg',
  ...
  '@layout-header-background',
  '@layout-header-color',
  '@global-content-bg-color',
  '@global-delete-hover-bg-color',
  '@global-base-table-title-color',
  '@global-base-table-flag-bg-color',
  '@global-base-table-thead-bg-color',
  '@normal-border-color',
  '@global-container-layout-header-box-shadow',
  '@global-container-layout-header-border-bottom',
  '@global-container-layout-header-toggle-color',
  '@global-container-layout-header-avatar-color',
  '@global-container-layout-header-avatar-bg-color',
  '@global-container-layout-header-bg-color',
  '@global-container-layout-header-border-color',
  '@global-container-layout-header-logo-color',
  '@global-container-layout-header-name-color',
  '@global-container-layout-sider-color',
  '@global-container-layout-sider-hover-bg-color',
  '@global-container-layout-sider-hover-text-color',
  '@global-container-layout-sider-item-selected-bg-color',
  '@global-container-layout-sider-item-selected-color',
  '@panel-with-child-header-bg-color',
  '@panel-with-child-header-border-color',
  ...
  '@questionnaire-item-active-bg-color',
  '@questionnaire-item-text-second-color',
  '@tab-btn-active-bg-color',
  '@tab-btn-bg-color',
  '@tab-btn-color',
